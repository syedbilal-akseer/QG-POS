...
class OraclePriceListUpdate extends Model
{
    ...
    // Same Oracle table that the user-driven "Send to Oracle" review flow uses
    // for both end-date and new-price inserts. The previous target
    // `apps.qg_price_list_updates` does not exist on this Oracle instance and
    // every insert silently failed with ORA-00942.
    protected $table = 'apps.qg_price_list_enddate';
