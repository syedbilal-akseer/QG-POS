 ...
 */
class VendorBillController2 extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.vendor-bills-2.index', [
            'bills'        => $bills,
            'counts'       => $counts,
    ...
    {
        return view('admin.vendor-bills-2.form', [
            'bill'    => null,
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor-bills-2.show', $bill);
    }
    ...
    public function show(VendorBill $vendorBill)
    {
        ...
        return view('admin.vendor-bills-2.show', [
            'bill' => $vendorBill,
        ]);
    }
    ...
    public function update(Request $request, VendorBill $vendorBill)
    {
        ...
        return redirect()->route('vendor-bills-2.show', $vendorBill);
    }
