...
class CustomerVisitController extends Controller
{
    ...
    public function visitMark(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logActivity('CRM', 'visit_mark', "Mobile App: Completed visit for customer {$visit->customer->customer_name}.", [
                'visit_id' => $visit->id,
    ...
    public function startVisit(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->logActivity('CRM', 'visit_start', "Mobile App: Started visit for customer {$visit->customer->customer_name}.", [
                'visit_id' => $visit->id,
                'customer_id' => $visit->customer_id
            ]);
    ...
    public function endVisit(Request $request, $visitId): JsonResponse
    {
        ...
        try {
            ...
            $this->logActivity('CRM', 'visit_end', "Mobile App: Ended visit for customer {$visit->customer->customer_name}.", [
                'visit_id' => $visit->id,
                'customer_id' => $visit->customer_id
            ]);
