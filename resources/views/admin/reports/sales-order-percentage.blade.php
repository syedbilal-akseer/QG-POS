            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-5">
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                        Source: <span class="font-mono">APPS.QG_SALES_ORDER_PERCENTAGE</span>. Cells show
                    ...
                    <table class="min-w-full text-sm">
                        <thead class="bg-gray-900 text-white">
                            <tr>
                                ...
                                @endforeach
                                <th class="px-4 py-2 text-right font-semibold whitespace-nowrap">Total Orders</th>
                                <th class="px-4 py-2 text-right font-semibold whitespace-nowrap">Mobile Orders</th>
                                <th class="px-4 py-2 text-right font-semibold whitespace-nowrap">Overall Mobile %</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            @php
                                $grandMob = 0; $grandTot = 0;
                            @endphp
