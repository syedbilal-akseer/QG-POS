<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-2xl font-semibold text-gray-900 mb-6">Goal Setting</h1>
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg rounded-xl border border-gray-100 p-6 text-center">
                <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <h3 class="mt-2 text-sm font-medium text-gray-900">No Goals Found</h3>
                <p class="mt-1 text-sm text-gray-500">Get started by creating a new SMART goal.</p>
                <div class="mt-6">
